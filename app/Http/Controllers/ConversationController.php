   ...
   public function index(){
    ...
    public function show($id){
        ...
        if(Gate::denies('my-conversation',$conversation)){
             return redirect(route('student.error'));
        }
    ...
    public function destroy(Request $req){
        ...
        return redirect(route('chatrooms.lists'))->with('msg','The conversation was successfully deleted');
