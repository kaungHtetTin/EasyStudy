					...
					<div class="col-12">
						<div class="course__form">
                            <div class="general_info10">
                                <form action="{{route('instructor.blogs.save')}}" method="post" enctype="multipart/form-data" id="form_blog_create">
                                    @csrf
                                    <div class="row">
										...
										<div class="col-lg-12 col-md-12">															
											<div class="ui search focus lbel25 mt-30">	
												...
												<div class="ui form swdh30">
													<div class="field">
														<textarea rows="3" name="summary" id="input_summary" placeholder="Blog summary here ..."></textarea>
													</div>
												</div>
                                        ...
                                        <div class="col-12">
                                        <div class="mt-30">
                                            <button id="btn_submit" type="button" class="main-btn" style="float:right">Post</button>
                                        </div>
                                        </div>
