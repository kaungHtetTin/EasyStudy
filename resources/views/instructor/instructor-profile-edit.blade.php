				...
				<div class="fcrse_1" style="padding:10px;">
					<div class="row">
						...
						<div class="col-lg-12 col-md-12">
										...
										@foreach ($user->social_contacts as $contact)
											<tr>
												...
												<td class="text-center">
													<a href="#" title="Delete Contact" data-toggle="modal" data-target="#delete-section" class="gray-s"><i class='uil uil-trash-alt'></i></a>
												</td> 
											</tr>
							...
							<span style="float:right;" class="btn_span" type="button" data-toggle="collapse" data-target="#add_social_form_container">Add New<i class='uil  uil-angle-down'></i></span> 
							  
							<div class="course_des_textarea mt-30 lbel25 collapse" id="add_social_form_container">
							 
								<form class="form" action="{{route('instructor.profile.add-social-contact')}}" method="POST" id="form_social_contact">
									@csrf
